...
const APIDocumentation = () => {
  ...
  const endpoints = {
    'get-all': {
      ...
      url: `https://api-house-delta.vercel.app/api/${activeAPI}`,
        ...
        data: `[
  {
    ...
    'get-by-id': {
      ...
      url: `https://api-house-delta.vercel.app/api/${activeAPI}/{id}`,
      pathParams: ['id'],
      response: {
        status: 200,
        data: `{
    ...
    'get-by-query': {
      ...
      url: `https://api-house-delta.vercel.app/api/${activeAPI}?status=compleated&priority=high`,
      queryParams: ['status','priority'],
      response: {
        status: 200,
        data: `{
